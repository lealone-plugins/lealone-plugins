...
进入 `target` 目录，运行: java -jar create-lealone-app-8.0.0-SNAPSHOT.jar [选项]
...
java -jar create-lealone-app-8.0.0-SNAPSHOT.jar -groupId com.lealone.examples.hello -artifactId hello
