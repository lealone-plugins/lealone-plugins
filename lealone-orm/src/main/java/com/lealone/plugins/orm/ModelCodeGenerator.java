 ...
 */
package com.lealone.plugins.orm;
...
public class ModelCodeGenerator extends TableCodeGeneratorBase {
    ...
    public void genCode(ServerSession session, Table table, Table owner, int level) {
        ...
        importSet.add("com.lealone.plugins.orm.Model");
        importSet.add("com.lealone.plugins.orm.ModelTable");
        importSet.add("com.lealone.plugins.orm.ModelProperty");
        importSet.add("com.lealone.plugins.orm.format.JsonFormat");
    ...
    private static String getModelPropertyClassName(int type, TreeSet<String> importSet) {
        ...
        name = "P" + name;
        importSet.add("com.lealone.plugins.orm.property." + name);
        return name;
    }
